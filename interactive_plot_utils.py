...
def make_station_df(data):
    ...
    if data.city == 'nyc':
        ...
        station_df = gpd.tools.sjoin(station_df, zoning_df, predicate='within', how='left')
        ...
        station_df = gpd.tools.sjoin(station_df, CTracts_df, predicate='within', how='left')
        ...
        station_df['pop_density'] = station_df.apply(lambda stat: stat['population']/stat['CT_area'], axis=1)
