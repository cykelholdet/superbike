...
def get_Davies_Bouldin_index(data_mat, centers, labels, verbose=False):
       """
...
def get_Dunn_index(data_mat, centers, labels=None, verbose=False):
    """
...
def get_silhouette_index(data_mat, centers, labels, verbose=False):
    """
